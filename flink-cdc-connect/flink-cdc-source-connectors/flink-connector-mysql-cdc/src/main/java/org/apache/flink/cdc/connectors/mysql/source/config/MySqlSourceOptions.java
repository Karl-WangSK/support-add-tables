...
public class MySqlSourceOptions {
    ...
    @Experimental
    public static final ConfigOption<Boolean> SCAN_SNAPSHOT_NON_PRIMARY_KEY_SKIP =
            ConfigOptions.key("scan.snapshot.non.primary.key.skip")
                    .booleanType()
                    .defaultValue(false)
                    .withDescription(
                            "whether skip non primary key tables in snapshot");
